...
CLOUDFLARE_TUNNEL_NAME="$(python3 "${SCRIPT_DIR}/Component/lib/read-deploy-setting.py" cloudflare_tunnel_name)"
RUNNER_NAME="$(python3 "${SCRIPT_DIR}/Component/lib/read-deploy-setting.py" runner_name)"
RUNNER_LABEL="$(python3 "${SCRIPT_DIR}/Component/lib/read-deploy-setting.py" runner_label)"
