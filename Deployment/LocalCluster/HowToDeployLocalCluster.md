...
Deployment/LocalCluster/scripts/support/      shell helpers called by commands or CI
Deployment/LocalCluster/scripts/lib/          Python helpers and audit checks
Deployment/LocalCluster/scripts/node-db/      scripts copied onto node-db
```
